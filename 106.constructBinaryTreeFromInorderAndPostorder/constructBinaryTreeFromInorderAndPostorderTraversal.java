...
class Solution {
    ...
    public TreeNode buildTreeHelper(int[] inorder, int[] postorder, int iStart, int iEnd, int pStart, int pEnd,
        ...
        root.left =
            buildTreeHelper(inorder, postorder, iStart, pivot - 1, pStart, pEnd - iEnd + pivot - 1, inorderIndex);
