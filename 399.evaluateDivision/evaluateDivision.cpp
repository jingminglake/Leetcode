...
public:
    ...
    double dfs(string start, string end, unordered_set<string>& visited, unordered_map<string, vector<string>>& edges,
               unordered_map<string, vector<double>>& edgesValue, double curValue) {
