...
public:
    ...
    void bfs(string beginWord, unordered_set<string>& dict, unordered_map<string, int>& steps,
             unordered_map<string, vector<string>>& nexts) {
        queue<string> q;
        q.push(beginWord);
        steps[beginWord] = 0;
    ...
    void dfs(vector<vector<string>>& ans, vector<string>& path, string beginWord, string endWord,
             unordered_map<string, int>& steps, unordered_map<string, vector<string>>& nexts) {
