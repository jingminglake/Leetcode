...
public:
    ...
    TreeNode* generate(vector<int>& preorder, int pStart, int pEnd, vector<int>& inorder, int iStart, int iEnd,
        ...
        TreeNode* leftChild =
            generate(preorder, pStart + 1, pStart + index - iStart, inorder, iStart, iStart + index - 1, m);
